...
public abstract class AbstractFuture<V> implements ListenableFuture<V> {
   ...
   */
    ...
    public V get(long timeout, TimeUnit unit)
        ...
        if (localValue != null & !(localValue instanceof com.google.common.util.concurrent.AbstractFuture.SetFuture)) {
   ...
   */
    ...
    public boolean isDone() {
        ...
        return localValue != null & !(localValue instanceof com.google.common.util.concurrent.AbstractFuture.SetFuture);
    }
        ...
        if (localValue == null | localValue instanceof com.google.common.util.concurrent.AbstractFuture.SetFuture) {
            ...
            do {
                if (ATOMIC_HELPER.casValue(this, localValue, valueToSet)) {
                    ...
                    complete();
                    if (localValue instanceof com.google.common.util.concurrent.AbstractFuture.SetFuture) {
            ...
            } while (localValue instanceof com.google.common.util.concurrent.AbstractFuture.SetFuture);
        }
        return false;
    }
